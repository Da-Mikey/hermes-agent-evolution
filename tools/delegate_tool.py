...
def strip_residual_template_markers(text: str) -> "tuple[str, list[str]]":
    """Remove any remaining template markers, returning ``(cleaned, removed)``."""
    removed: List[str] = []
    ...
    return _TEMPLATE_MARKER_RE.sub(_repl, text), removed
