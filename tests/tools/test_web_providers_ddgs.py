...
class TestDDGSProviderSearch:
    ...
    def test_empty_results(self, monkeypatch):
        ...
        # Issue #467 — DDGS returning no results is a provider failure symptom
        # (automated queries blocked), not a successful zero-result outcome.
        assert result["success"] is False
        assert "duckduckgo returned no results" in result["error"].lower()
