...
LEGACY_AUTHOR_MAP = {
    # Fork-specific identity preserved across the upstream sync: the repo
    # owner is absent from upstream's map, kept here so the check-attribution
    # CI gate still resolves fork-maintenance commits.
