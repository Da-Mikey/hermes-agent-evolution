...
AGENT_RUNTIME_POST_HOOK_TOOL_NAMES = frozenset(
    {
        "annotate_preview", "clarify", "compact_context", "delegate_task", "drive_preview", "memory", "read_preview", "read_terminal", "read_window_below", "session_search", "setup_mcp", "todo", "tour"
    }
)
